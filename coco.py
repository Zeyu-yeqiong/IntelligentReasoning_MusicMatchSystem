...
class COCO2014(data.Dataset):
    ...
    def get(self, item):
        ...
        print(os.getcwd())
        img = Image.open('static\\images\\test.jpg').convert('RGB')
        # img_test = Image.open('G:\\ML-GCN-master\\test\\COCO_val2014_000000000042.jpg').convert('RGB')
        ...
        #print("img",img)  # (3,448,448)
        #print(self.inp.shape)   # (80,300)(node features)
